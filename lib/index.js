                ...
                { h2: `Public IP: \`${data.ip}\`` },
                {
                    table: {
                        ...
                        rows: [
                            ...
                            [ "City", `[${data.city}](${MAPS_URL}${data.city})`],
                            [ "Region", `[${data.region}](${MAPS_URL}${data.region})`],
                            [ "Country", `[${data.country}](${MAPS_URL}${data.country})`],
                            [ "Coordinates", `[${data.loc}](${MAPS_URL}${data.loc})`],
                            [
                                "Map",
                                {
                                    img: {
                                        title: "Location",
                                        source: `https://maps.googleapis.com/maps/api/staticmap?center=${data.loc}&zoom=9&size=640x200&sensor=false`
                                    }
                                }
                            ]
                        ]
